...
public class ProfileController extends Controller
{
    ...
    public void initialize()
    {
        ...
        Image editProfileImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/edit-profile.png")));
        editProfile.setImage(editProfileImage);

        Image passwordImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/password.png")));
