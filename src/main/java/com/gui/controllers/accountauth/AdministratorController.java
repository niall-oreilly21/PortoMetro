package com.gui.controllers.accountauth;
...
public class AdministratorController extends Controller
{
    ...
    public void initialize()
    {
        ...
        Image adminImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/administrator.png")));
        administratorIcon.setImage(adminImage);

        Image trainImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/train.png")));
        trainsIcon.setImage(trainImage);

        Image usersImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/group.png")));
        usersIcon.setImage(usersImage);

        Image cardsImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/card-white.png")));
        cardsIcon.setImage(cardsImage);

        Image signOutImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/sign-out.png")));
