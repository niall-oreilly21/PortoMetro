...
public abstract class Controller
{
    ...
    {
        Image logoImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/logo.png")));
        logo.setImage(logoImage);
    }

    protected void initialiseMetroImage(String name)
    {
        Image image = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/metro/" + name + ".jpg")));
        metro.setImage(image);
    }

    protected void initialiseProfileIcon()
    {
        Image profileImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/profile.png")));
        profile.setImage(profileImage);
    }

    protected void initialiseCardIcon()
    {
        Image cardImage = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/img/icons/card.png")));
    ...
    public void redirectToPage(ActionEvent event, Folder folder, Page page) throws IOException
    {
        FXMLLoader loader = new FXMLLoader(
                Objects.requireNonNull(Controller.class.getClassLoader()
                        .getResource("fxml/" + folder.getLabel() + "/" + page.getLabel() + ".fxml")));
